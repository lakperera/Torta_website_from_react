        ...
        <div>
            ...
            */}
            ...
            <div className="container">
                ...
                <li className="footer-nav-item">
                    <a href="#" className="footer-nav-link">Chocolate Cake</a>
                </li>

                <li className="footer-nav-item">
                    <a href="#" className="footer-nav-link">Pudding</a>
                </li>

                <li className="footer-nav-item">
                    <a href="#" className="footer-nav-link">Brownies</a>
                </li>

                <li className="footer-nav-item">
                    <a href="#" className="footer-nav-link">Buriani</a>
                </li>

                <li className="footer-nav-item">
                    <a href="#" className="footer-nav-link">Pizza</a>
                </li>
                ...
                <li className="footer-nav-item flex">
                    ...
                    <a href="tel:+94 11xxxxx" className="footer-nav-link">(941) 11-xxxxx</a>
                </li>
