...
const handlePictureChange = (event) => {
    const file = event.target.files[0];
        ...
        ImageResizer.imageFileResizer(
            ...
            0, // Rotation (optional)
            (uri) => {
            // uri is the resized image data URL
            // You can use this uri for preview or upload
    ...
    <div>
      <div className="container light-style flex-grow-1 container-p-y">
                    ...
                    <div className="tab-content">
                        <div className="tab-pane fade active show" id="account-general">
                            <div className="card-body media align-items-center">
                                {
                                    profilePhoto ? <img id="preview" src={URL.createObjectURL(profilePhoto)} alt=""/> :<img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt=""
                                ...
                                <div className="media-body ml-4">
                                    ...
                                    <label className="btn btn-outline-primary">
                                        Upload new photo
                                        <input type="file" className="account-settings-fileinput" onChange={handlePictureChange}/>
                                    </label> &nbsp;
        ...
        <div className="text-right mt-3">
            <button type="button" className="btn btn-primary" onClick={handelUpload}>Save changes</button>&nbsp;
